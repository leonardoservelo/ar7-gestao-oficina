...
async function requestHandler(req,res){
  ...
  if(url.pathname==='/health'){
    ...
    json(res,database||!isHosted?200:503,{ok:true,app:'AR7 Gestão da Oficina',version:'20.2.3',databaseConfigured:Boolean(pool),databaseConnected:database,timestamp:new Date().toISOString()});return;
  }
...
function listenOn(candidate){
  ...
  candidateServer.listen(candidate,host,()=>{
    ...
    console.log('==============================================================');
    console.log(' AR7 Gestao da Oficina V20.2.3 - Revisao Geral + Banco Central');
