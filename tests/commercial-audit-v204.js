...
check('release V20.2.4 consistente',app.includes("const APP_RELEASE = '20.2.4'")&&pkg.version==='20.2.4'&&index.includes('app.js?v=20.2.4')&&index.includes('styles.css?v=20.2.4'));
