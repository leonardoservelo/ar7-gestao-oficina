...
check('release V20.2.4 consistente',app.includes("const APP_RELEASE = '20.2.5'")&&pkg.version==='20.2.5'&&index.includes('app.js?v=20.2.5')&&index.includes('styles.css?v=20.2.5'));
