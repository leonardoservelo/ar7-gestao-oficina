...
const dashboard=renderHash('#dashboard');check('topo direito mostra apenas desenvolvedor e versão',dashboard.includes('developer-workspace-v205')&&dashboard.includes('Nexora Sistemas')&&dashboard.includes('v20.2.8')&&!/developer-workspace-v205[^>]*>[^<]*AR7 El/i.test(dashboard));
...
console.log(`\n${passed}/${total} verificações V20.2.8 aprovadas.`);if(passed!==total)process.exit(1);
