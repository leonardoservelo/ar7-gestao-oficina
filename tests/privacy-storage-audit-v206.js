...
check('release V20.2.8 consistente',pkg.version==='20.2.8'&&app.includes("const APP_RELEASE = '20.2.8'")&&server.includes('version:APP_RELEASE')&&index.includes('app.js?v=20.2.8'));
...
console.log(`\n${passed}/${total} verificações V20.2.8 de privacidade/armazenamento aprovadas.`);
